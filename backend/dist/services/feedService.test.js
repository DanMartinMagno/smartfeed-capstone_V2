...
describe('Feed Formulation Service', () => {
    ...
    it('should calculate different nutrient values for different feed types', () => {
        const selectedIngredients = ['Coconut Residue', 'Water Spinach', 'Cassava Leaves'];
        const numSwine = 5;
        const starterResult = (0, feedService_1.feedFormulation)(selectedIngredients, 'starter', numSwine);
        const growerResult = (0, feedService_1.feedFormulation)(selectedIngredients, 'grower', numSwine);
        const finisherResult = (0, feedService_1.feedFormulation)(selectedIngredients, 'finisher', numSwine);
