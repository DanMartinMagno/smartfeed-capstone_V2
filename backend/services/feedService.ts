...
const calculateNutrients = (
  ...
  const totalCrudeProtein = selectedIngredients.reduce(
    (acc, ingredient) => acc + ingredient.nutrients.crudeProtein,
    0
  );
  ...
  const totalNutrients = selectedIngredients.reduce(
    (acc, ingredient) => {
      ...
      return {
        crudeProtein:
          acc.crudeProtein +
          (ingredient.nutrients.crudeProtein * totalAmount) / totalDailyFeed,
        crudeFiber:
          acc.crudeFiber +
          (ingredient.nutrients.crudeFiber * totalAmount) / totalDailyFeed,
        crudeFat:
          acc.crudeFat +
          (ingredient.nutrients.crudeFat * totalAmount) / totalDailyFeed,
        calcium:
          acc.calcium +
          (ingredient.nutrients.calcium * totalAmount) / totalDailyFeed,
        moisture:
          acc.moisture +
          (ingredient.nutrients.moisture * totalAmount) / totalDailyFeed,
        phosphorus:
          acc.phosphorus +
          (ingredient.nutrients.phosphorus * totalAmount) / totalDailyFeed,
      };
    },
    {
      crudeProtein: 0,
...
const feedFormulation = (
  ...
  const nutrientAnalysis = calculateNutrients(
    selectedIngredientObjects as Ingredient[],
    numSwine,
    type
  );
  ...
  const perSwineNutrients = {
    crudeProtein: nutrientAnalysis.totalNutrients.crudeProtein / numSwine,
  ...
  const analysisResults = {
    ingredientAmounts: nutrientAnalysis.ingredientAmounts,
    totalNutrients: perSwineNutrients,
    recommendations: recommendations,
    analysis: {
      crudeProtein:
        perSwineNutrients.crudeProtein >= recommendations.crudeProtein
          ? "Sufficient"
          : "Deficient",
      crudeFiber:
      ...
      calcium:
        perSwineNutrients.calcium >= recommendations.calcium
          ...
          : "Deficient",
      moisture:
        perSwineNutrients.moisture >= recommendations.moisture
          ? "Sufficient"
          : "Deficient",
      phosphorus:
        perSwineNutrients.phosphorus >= recommendations.phosphorus
          ? "Sufficient"
          : "Deficient",
    },
  };
...
export { feedFormulation, getNutrientRecommendations };
